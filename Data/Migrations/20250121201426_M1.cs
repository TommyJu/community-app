    ...
    public partial class M1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vancouver", 3000000, "BC", null },
                    { 2, "Victoria", 850000, "BC", null },
                    { 3, "Surrey", 500000, "BC", null },
                    { 4, "Toronto", 2800000, "ON", null },
                    { 5, "Ottawa", 1000000, "ON", null },
                    { 6, "Mississauga", 700000, "ON", null },
                    { 7, "Calgary", 1200000, "AB", null },
                    { 8, "Edmonton", 1300000, "AB", null },
                    { 9, "Banff", 10000, "AB", null }
                });
